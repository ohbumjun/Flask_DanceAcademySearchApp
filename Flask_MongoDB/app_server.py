...
client = MongoClient('mongodb://dhsys112:bjoh1227!!@13.124.200.119', 27017)
db = client.Dance
...
def read_reviews():
    ...
    Classes = list( db.Dance_Collection.find( { 'Genre' : Genre_receive , 'Day_1' : Day_receive  ,  'Time_1' : Time_receive, 
